...
describe('CliClient', () => {
  ...
  describe('constructor', () => {
    ...
    it('should use TCP on Windows', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'win32',
      });
    ...
    it('should use Unix socket on Linux', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'linux',
      });
    ...
    it('should use Unix socket on macOS', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'darwin',
      });
  ...
  describe('isDaemonRunning', () => {
    ...
    it('should return true when socket file exists on Linux', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'linux',
      });
    ...
    it('should return false when socket file does not exist on Linux', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'linux',
      });
    ...
    it('should return true when socket file exists on macOS', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'darwin',
      });
  ...
  describe('connect', () => {
    it('should connect to daemon on Windows', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'win32',
      });
    ...
    it('should connect to daemon on Linux', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'linux',
      });
    ...
    it('should throw if daemon not running on Linux', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'linux',
      });
  ...
  describe('disconnect', () => {
    ...
    it('should disconnect from daemon on Windows', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'win32',
      });
  ...
  describe('error handling', () => {
    ...
    it('should handle connect errors on Linux', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'linux',
      });
    ...
    it('should handle connect errors on Windows', async () => {
      Object.defineProperty(process, 'platform', {
        value: 'win32',
      });
